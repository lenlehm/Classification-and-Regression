...
class NeuralNet():
    ...
    def __init__(self, xData, yData, nodes=[1, 10, 1], activations=['sigmoid', None], cost_function='mse', regularization=None, lamda=0.0):
        """
    ...
    def activation_derivative(self, x, act_func):
        """
        Calculate the activation function derivatives
        INPUT:
        ---------
        x: numpy ndarray
            data that should be chased through the activation function
    ...
    def trainingNetwork(self, epochs=1000, batchSize=200, tau=0.01, n_print=100):
        ...
        for epoch in range(epochs +1):
            ...
            if epoch == 0 or epoch % n_print == 0:
                ...
                print("{} epoch: Training Error:  {}, Test Error  {}".format(epoch, trainError, testError))
